        ...
        <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="flex flex-col">
                    ...
                    <input class="bg-transparent border-0 border-b border-outline-variant focus:border-on-surface focus:ring-0 px-0 py-2 font-body-lg text-body-lg text-on-surface placeholder:text-on-surface-variant/40 transition-colors" id="email" name="email" value="{{ old('email') }}" placeholder="e.g. student@example.com" type="email" required/>
                </div>
                <div class="flex flex-col">
